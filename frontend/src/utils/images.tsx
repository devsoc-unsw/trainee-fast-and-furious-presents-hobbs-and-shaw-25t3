export const cuisineImages: Record<string, string[]> = {
  italian: [
    ...
    "https://burratahouse.com/wp-content/uploads/nc/articles/Italian_Food_9ee0b58d-018f-4c37-a7b3-4a677b75f66f.jpg"
  ],
  bakery: [
    ...
    "https://d23hgm0tds3lcv.cloudfront.net/wp-content/uploads/2022/11/22-10-Wholesale-Bakery-Bread-Pastry-WEB-0233-Edit-1.jpg",
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTZEsBTB0YAzjN2i2W7PuzRjxDq_CPMX3QbNQ&s",
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTsCLgtsQdIEOJeavoeJBkp3AcGoyMDSdxy0A&s",
    "https://nugget-markets-01.s3.us-west-1.amazonaws.com/nugget/p/bakery-breads-group-9exsl4qvuxvzmec5.jpg",
  ...
  japanese: [
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSknmkfiNPBerM57JkLPymsluo3eH0P9x_JAQ&s",
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ8usUrU4524wv_DelZPLVfS2AAQV6AXU9-Sw&s",
    "https://www.harbourtownadelaide.com.au/assets/images/Stores/Sushi-Sushi/_1200x630_crop_center-center_82_none/1000px_SUSHISUSHI__Pack-Sushi-Deluxe.jpg?v=1759373330",
  ...
  mexican: [
    ...
    "https://delishglobe.com/wp-content/uploads/2024/10/Tacos.png"
  ],
  korean: [
    "https://bokksumarket.com/cdn/shop/articles/shutterstock_1800999814_58e4fd5d-7ef4-45de-ad94-3328464f5070.jpg?v=1752044432",
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSNZx4pFwCIJJ_Xr65aKRl9us_jjVK0rAD7AA&s",
    "https://images.yummy.ph/yummy/uploads/2022/04/koreanfoodramyunwithtteokbokki.jpg",
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR1ZeTAgmqygW0POBrH44ePis8SubDMNWI4oQ&s"
  ],
  indian: [
    "https://www.rewardsnetwork.com/wp-content/uploads/2016/12/IndianFood_Main.jpg",
    "https://www.contiki.com/six-two/app/uploads/2024/03/IMG-20240318-WA0007-e1710844435378.jpg",
    "https://www.tastingtable.com/img/gallery/20-delicious-indian-dishes-you-have-to-try-at-least-once/l-intro-1733153567.jpg"
  ],
  cafe: [
    ...
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSQ6x46i2Zyr-fFNWgInA5KzBgc5hxm52OX1A&s",
...
export function getCuisineImage(
  cuisines?: string
): string {
  if (!cuisines) {
  ...
  for (const cuisine of cuisineList) {
    if (cuisineImages[cuisine]) {
      return randomFrom(cuisineImages[cuisine]);
    }
  }
